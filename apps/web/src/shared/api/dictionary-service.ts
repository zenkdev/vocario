...
import { createDictionary, createStatistic, createWord, type Dictionary, type Statistic, type Word } from '@/shared/model';
import { count } from '@/shared/lib';
...
export const dictionaryService = new DictionaryService(firebaseInstance);
